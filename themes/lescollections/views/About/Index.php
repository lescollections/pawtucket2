...
?>
<H1><?php print _t("A propos"); ?></H1>
<div class="row">
	<div class="col-sm-6 col-md-6">
	<p>Un Catalogue Raisonné des oeuvres de Louis Floutier est en cours d' élaboration depuis juillet 2010. C’est un travail collaboratif d’inventaire qui a vocation d être exhaustif au long cours. Actuellement, nous avons 894 fiches, dont 726 illustrées (10/4/2015). </p>
	<p>Vous pouvez y contribuer en nous faisant parvenir les dimensions , le support (toile, carton, panneau, papier, faience, poterie, etc ) et une photo de qualité des oeuvres de l’artiste en votre possession. Tout autre document nous sera également utile pour enrichir notre connaissance. <br> La confidentialité de toute information fournie sera bien sûr garantie.  </p>
	</div>
	<div class="col-sm-6 col-md-6">
