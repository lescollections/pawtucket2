...
<?php
							...
							foreach($va_sets as $vn_set_id => $va_set){
								...
								print "<div class='galleryItem'>
											<a href='#' onclick='jQuery(\"#gallerySetInfo\").load(\"".caNavUrl($this->request, '', 'Storymap', 'getSetInfo', array('set_id' => $vn_set_id))."\"); return false;'>
...
?>
		...
		<script type='text/javascript'>
			jQuery(document).ready(function() {		
				jQuery("#gallerySetInfo").load("<?php print caNavUrl($this->request, '*', 'Storymap', 'getSetInfo', array('set_id' => $vn_first_set_id)); ?>");
			});
		</script>
<?php
	}
