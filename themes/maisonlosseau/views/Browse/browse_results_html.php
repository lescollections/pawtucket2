...
print _t(_t('%1 %2 %3'), $qr_res->numHits(), ($qr_res->numHits() == 1) ? $t_instance->getProperty('NAME_SINGULAR') : $t_instance->getProperty('NAME_PLURAL'), ($qr_res->numHits() == 1) ? _t("Result") : _t("Results")); ?>
